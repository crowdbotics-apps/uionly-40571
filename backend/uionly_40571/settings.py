"""
Django settings for uionly_40571 project.
...
ROOT_URLCONF = 'uionly_40571.urls'
...
WSGI_APPLICATION = 'uionly_40571.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "uionly_40571 API",
    "DESCRIPTION": "API documentation for uionly_40571 App",
    "VERSION": "v1",
}
